...
const MyWorkshopDetails = () => {
    ...
    if (loading) {
        return <GridLoader color="#1a202c" size={15} margin={2} />;
    }
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto grid max-w-2xl grid-cols-2 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none ">
                            <div className='lg:col-span-1 col-span-full'>
                                ...
                                {/* Button to open UpdateModal */}
                                <div className="mt-10 flex items-center gap-x-6">
                                    <Button
                                        onClick={handleOpenModal}
                                        className="rounded-md bg-mainColoe px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                        Update
                                    </Button>
                                </div>
                                {/* UpdateModal component */}
                                <UpdateModal isOpen={isModalOpen} onClose={handleCloseModal} workshop={workshop} />
                            </div>
                            <div className='lg:col-span-1 col-span-full'>
