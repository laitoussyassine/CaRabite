...
import { fetchWorkshopById } from '../../store/features/workshop/workshopAction.js'; // Import the fetchWorkshopDetails action
    ...
    return (
        <div className='bg-gray-100 h-screen'>
            {workshop && (
                ...
                <div className=" dark:bg-gray-800 py-16 flex justify-around">
                    <div className="px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col md:flex-row mx-4">
                            <div className="md:flex-1 px-4">
                                <div className="h-[400px] rounded-lg bg-gray-300 object-cover dark:bg-gray-700 mb-4">
                                    <img src={workshop.image} className="h-full w-full" />
                                </div>
                        ...
                        <div className="mt-[30px] bg-white h-fit py-5 px-10 w-2/12">
