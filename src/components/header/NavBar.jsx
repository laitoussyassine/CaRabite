    ...
    <>
      <nav className="flex flex-wrap items-center md:justify-around justify-between p-3 bg-slate-100">
        ...
        <div className={`${menuOpen ? 'flex flex-col' : 'hidden'} w-full md:w-auto md:flex flex-row text-left text-bold mt-5 md:mt-0`}>
          <Link to={'/'} className="block md:inline-block text-lg text-black hover:text-mainColoe font-bold px-3 py-3   ">Home</Link>
          <Link to={'/about'} className="block md:inline-block text-lg text-black hover:text-mainColoe font-bold px-3 py-3   ">About</Link>
